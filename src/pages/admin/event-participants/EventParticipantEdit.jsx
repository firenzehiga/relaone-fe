					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
						<div>
							<label
								...
								Event <span className="text-gray-400 italic text-xs">(read only)</span>
							</label>
							<select
								id="event_id"
								{...register("event_id")}
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
						<div>
							<label
								...
								className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
								Tanggal Daftar <span className="text-gray-400 italic text-xs">(read only)</span>
							</label>
							<input
								id="tanggal_daftar"
								type="date"
					...
					<div className="mt-auto pt-6">
						<div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2 sm:gap-3">
							...
							<Button
								...
								{isLoading || isSubmitting ? "Menyimpan..." : "Simpan Participant"}
							</Button>
						</div>
					</div>
				</form>
