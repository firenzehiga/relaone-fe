...
function SkeletonCard({ className }) {
	return (
		<div className={cn("bg-slate-200 border rounded-lg p-6", className)}>
			<CustomSkeleton className="h-4 w-3/4 mb-4" />
			<CustomSkeleton className="h-3 w-full mb-2" />
			<CustomSkeleton className="h-3 w-2/3 mb-4" />
			<div className="flex justify-between items-center">
				<CustomSkeleton className="h-6 w-20" />
...
function SkeletonLine({ className }) {
	return <CustomSkeleton className={cn("h-4 w-full", className)} />;
}
...
CustomSkeleton.Card = SkeletonCard;
CustomSkeleton.EventCard = SkeletonEventCard;
CustomSkeleton.Line = SkeletonLine;
CustomSkeleton.Text = SkeletonText;
				...
				<div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
					...
					<div className="md:col-span-5">
						<div className="rounded-lg overflow-hidden">
							<CustomSkeleton className="h-72 md:h-[640px] w-full bg-slate-200" />
						</div>
					</div>
					...
					<div className="md:col-span-7 space-y-4">
						<div className="flex items-start justify-between">
							<div className="space-y-3 w-full">
								<div className="flex items-center gap-3">
									<CustomSkeleton className="h-6 w-20 rounded-full bg-slate-100" />
									<div className="flex-1">
										<CustomSkeleton className="h-8 w-3/4 bg-slate-200" />
										<CustomSkeleton className="h-4 w-1/2 mt-2 bg-slate-200" />
									</div>
								</div>

								<div className="flex items-center gap-6 mt-3">
									<CustomSkeleton className="h-4 w-40 bg-slate-200" />
									<CustomSkeleton className="h-4 w-24 bg-slate-200" />
								</div>
							</div>
						</div>

						<div className="pt-2">
							<CustomSkeleton className="h-4 w-full bg-slate-200" />
							<CustomSkeleton className="h-4 w-5/6 mt-2 bg-slate-200" />
							<CustomSkeleton className="h-4 w-4/6 mt-2 bg-slate-200" />
						</div>

						<div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
							<div className="border rounded-lg p-4">
								<CustomSkeleton className="h-5 w-36 bg-amber-100" />
								<div className="mt-3 space-y-2">
									<CustomSkeleton className="h-3 w-full bg-slate-200" />
									<CustomSkeleton className="h-3 w-full bg-slate-200" />
									<CustomSkeleton className="h-3 w-3/4 bg-slate-200" />
									<CustomSkeleton className="h-3 w-2/3 bg-slate-200" />
								</div>
							</div>

							<div className="border rounded-lg p-4">
								<CustomSkeleton className="h-5 w-28 bg-slate-100" />
								<div className="mt-3 space-y-2">
									<CustomSkeleton className="h-3 w-full bg-slate-200" />
									<CustomSkeleton className="h-3 w-full bg-slate-200" />
									<CustomSkeleton className="h-3 w-3/4 bg-slate-200" />
						...
						<div className="mt-4">
							<div className="border rounded-lg p-4 flex items-center gap-4">
								<CustomSkeleton className="h-12 w-12 rounded-full bg-slate-200" />
								<div className="flex-1">
									<CustomSkeleton className="h-4 w-1/3 bg-slate-200" />
									<CustomSkeleton className="h-3 w-1/2 mt-2 bg-slate-200" />
								</div>
							</div>
						</div>
					</div>
...
CustomSkeleton.Detail = SkeletonDetail;
...
CustomSkeleton.OrganizationDetail = OrganizationDetailSkeleton;
...
CustomSkeleton.FormSkeleton = FormSkeleton;
...
CustomSkeleton.OrgSkeleton = OrgSkeleton;
...
CustomSkeleton.EventsSkeleton = EventsSkeleton;
		...
		<div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-4 px-4">
			<div className="max-w-7xl mx-auto">
				...
				<div className="text-center mb-6">
					<CustomSkeleton className="h-6 w-36 mx-auto mb-2 bg-slate-200 animate-pulse" />
					<CustomSkeleton className="h-4 w-72 mx-auto bg-slate-200 animate-pulse" />
				</div>
					...
					<div className="xl:col-span-1">
						<Card className="text-center h-fit">
							...
							<div className="relative mb-4">
								<CustomSkeleton className="w-32 h-32 rounded-full mx-auto bg-slate-200 animate-pulse" />
							</div>

							{/* Basic Info Skeleton */}
							<CustomSkeleton className="h-6 w-36 mx-auto mb-2 bg-slate-200 animate-pulse" />
							<CustomSkeleton className="h-4 w-48 mx-auto mb-4 bg-slate-200 animate-pulse" />

							{/* Edit Button Skeleton */}
							<CustomSkeleton className="h-8 w-full rounded-lg bg-slate-200 animate-pulse" />
							{/* Basic Info Skeleton */}
							<CustomSkeleton className="h-6 w-36 mx-auto mb-2 bg-slate-200 animate-pulse" />
							<CustomSkeleton className="h-4 w-48 mx-auto mb-4 bg-slate-200 animate-pulse" />
							...
							<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
								...
								<div>
									<div className="flex items-center mb-4">
										<CustomSkeleton className="w-5 h-5 mr-2 bg-slate-200 animate-pulse" />
										<CustomSkeleton className="h-6 w-36 bg-slate-200 animate-pulse" />
									</div>

									<div className="space-y-3">
										{[...Array(6)].map((_, index) => (
											<div key={index}>
												<CustomSkeleton className="h-3 w-20 mb-1 bg-slate-200 animate-pulse" />
												<div className="flex items-center">
													<CustomSkeleton className="w-3 h-3 mr-2 bg-slate-200 animate-pulse" />
													<CustomSkeleton className="h-4 w-28 bg-slate-200 animate-pulse" />
												</div>
											</div>
										))}
									</div>
								...
								<div>
									<div className="flex items-center mb-4">
										<CustomSkeleton className="w-5 h-5 mr-2 bg-slate-200 animate-pulse" />
										<CustomSkeleton className="h-6 w-44 bg-slate-200 animate-pulse" />
									</div>

									<div className="space-y-3">
										{[...Array(4)].map((_, index) => (
											<div key={index}>
												<CustomSkeleton className="h-3 w-16 mb-1 bg-slate-200 animate-pulse" />
												<CustomSkeleton
													className={`h-4 ${
...
CustomSkeleton.ProfileSkeleton = ProfileSkeleton;
...
CustomSkeleton.AnalyticsSkeleton = AnalyticsSkeleton;
...
CustomSkeleton.EventScannerSkeleton = EventScannerSkeleton;
...
CustomSkeleton.LoadingEventScanner = LoadingEventScanner;
...
CustomSkeleton.ActivityDetailSkeleton = ActivityDetailSkeleton;
...
CustomSkeleton.MyActivitiesSkeleton = MyActivitiesSkeleton;
