...
import { endpoints } from "../api/mockApi"; // Menggunakan mock API dengan TanStack Query

/**
 * Query keys untuk caching dan invalidation
 * Menggunakan hierarchical structure untuk easy invalidation
 */
